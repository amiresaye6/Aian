...
export class SlackAuthController {
  ...
  private readonly redirectUri = process.env.SKACK_REDIRECT_URL_PRODUCTION || "https://unsaddle-junkie-snowdrift.ngrok-free.dev/api/v1/integrations/slack/callback";
